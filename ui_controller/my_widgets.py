...
class clickable_label(QLabel):
    ...
    def mousePressEvent(self, e):
        if e.buttons() == Qt.LeftButton:
            self.event.SCL_click()
        elif e.buttons() == Qt.RightButton:
            self.event.SCR_click()
...
class my_text_browser(QTextBrowser):
    def __init__(self, parent):
        QTextBrowser.__init__(self, parent)
        self.setStyleSheet('QTextBrowser {background-color: #000000; color: #E6E6E6;}')
...
class my_label(QLabel):
    def __init__(self, parent):
        QLabel.__init__(self, parent)
        self.setStyleSheet('QLabel {color: #E6E6E6;}')
...
class my_cb(QCheckBox):
    def __init__(self, parent):
        ...
        # self.setStyleSheet('QCheckBox {color: #E6E6E6; spacing: 5px;}')


class my_cbb(QComboBox):
    def __init__(self, parent):
        QComboBox.__init__(self, parent)
        self.setStyleSheet('QComboBox {background-color: rgb(231, 230, 234); color: rgb(0, 0, 0);}')
